...
# ![Header](images/intro1.png)
# ![Header](images/intro2.png)

</div>

# Representação de funções booleanas sob a forma de Fórmulas de Lógica Proposicional FND/FNC

<table>
<tr>
<td>

> Dadas duas fórmulas de lógica proposicional, φ e ψ, φ ↔ ψ se e apenas se φ e ψ representarem a mesma função
booleana.

> Uma função booleana pode também ser representada sob a forma de uma
tabela de verdade que lista explicitamente o seu valor para todos os
valores possíveis dos seus argumentos.

> O objetivo deste problema é, dada uma função booleana sob a forma de
uma tabela de verdade que a representa, obter duas proposições da lógica
proposicional equivalentes a essa função, uma em Forma Normal Conjuntiva
(FNC) e outra em Forma Normal Disjuntiva.
...
[![Diogo Paulo](https://cdn.discordapp.com/attachments/1050105332891926569/1135606338160959699/j3DiVZMi_400x400.jpg)](https://github.com/Diogo365)| [![Tiago Barreiros](https://avatars.githubusercontent.com/u/78179371?s=100&v=4)](https://github.com/tiago-barreiros)
---|----------------------------------------------------------------------------------------------------------------------
[Diogo Paulo](https://github.com/Diogo365)|[Tiago Barreiros](https://github.com/tiago-barreiros)
